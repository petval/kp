...
export default component$(() => {
	return (
		<div class={S.header}>
			...
			<div class={S.para}>Všeobecné obchodní podmínky, dále jen <strong>VOP</strong>, spolu se všemi ostatními smluvními dokumenty, zejména <a class="font-bold text-slate-500 dark:text-blue-300" href='/obchodni-udaje/dpp'>Dodacími, platebními a storno podmínkami</a> a <a class="font-bold text-slate-500 dark:text-blue-300" href='/obchodni-udaje/rp'>Reklamačními podmínkami</a>, vymezují obsah smluvního vztahu mezi Objednatelem a Poskytovatelem.</div>
			...
			<div class={S.para}>3.4 Objednávka a nákup služeb se řídí <a class="font-bold text-slate-500 dark:text-blue-300" href='/obchodni-udaje/dpp'>Dodacími, platebními a storno podmínkami</a> a <a class="font-bold text-slate-500 dark:text-blue-300" href='/obchodni-udaje/rp'>Reklamačními podmínkami</a>.</div>
			<div class={S.para}>3.5 Smlouva je uzavřena okamžikem uhrazení ceny služby. Pokud by k uhrazení ceny služby v době splatnosti nedošlo, vyhrazuje si Poskytovatel právo od smlouvy odstoupit a uplatnit ustanovení v <a class="font-bold text-slate-500 dark:text-blue-300" href='/obchodni-udaje/dpp'>Dodacích, platebních a storno podmínkách</a>.</div>

			<div class={S.h2}>4. Práva a povinnosti smluvních stran</div>
			<div class={S.h3}>4.1 Práva a povinnosti Objednatele:</div>
			<div class={S.para}>4.1.1 Odesláním objednávky se Objednatel zavazuje zaplatit cenu objednaných a poskytnutých služeb a respektovat při tom ustanovaní <a class="font-bold text-slate-500 dark:text-blue-300" href='/obchodni-udaje/dpp'>Dodacích, platebních a storno podmínek</a>.</div>
			...
			<div class={S.para}>4.2.4 Poskytovatel prohlašuje, že jakékoliv datové soubory, které jsou předmětem smlouvy mezi Objednatelem a Poskytovatelem, chrání přiměřeně ve smyslu požadavků zákona 101/2000 Sb. o ochraně osobních údajů a zákona 110/2019 Sb. o zpracování osobních údajů, podrobně uvedených v <a class="font-bold text-slate-500 dark:text-blue-300" href='/obchodni-udaje/gdpr'>Ochraně osobních údajů</a>.</div>
			...
			<div class={S.para}>7.1 Odesláním elektronické objednávky smluvní strany potvrzují, že si tyto VOP zveřejněné na webu služby, které jsou neoddělitelnou součástí objednávky, přečetli a jejich obsahu plně porozuměli.</div>
			<div class={S.para}>7.2 Smluvní strany odesláním objednávky potvrzují, že do smluvního vztahu vstoupily na základě svobodné a vážné vůle, žádná ze stran nejednala v omylu, tísni či za nápadně nevýhodných podmínek, informace uvedené v písemné objednávce jako i tyto VOP si řádně přečetly, porozuměly jejich obsahu a jednotlivým pojmům, řádně si vysvětlily význam jednotlivých pojmů a porozuměly jim.</div>
			<div class={S.para}>7.3 Poskytovatel si vyhrazuje měnit tyto VOP kdykoliv.</div>
			<div class={S.para}>7.4 Tyto podmínky vstupjí v platnost dne 1.12.2023</div>
