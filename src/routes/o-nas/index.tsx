...
books.push(<span>Spoluautorka knihy <a href='https://www.databazeknih.cz/knihy/bonding-porodni-radost-podpora-rodiny-jako-cesta-k-ozdraveni-porodnictvi-a-spolecnosti-103506'><em>Bonding - porodní radost</em></a></span> as JSX.Element)
books.push(<span>Autorka knihy <a href='https://www.databazeknih.cz/knihy/pohadka-o-zrozeni-rodiny-315910'><em>Pohádka o zrození rodiny</em></a></span> as JSX.Element)

const items = [
	{
		name: 'Mgr. Michaela Bondy', pos: 'Klinická psycholožka, psychoterapeutka, soudní znalkyně', img: '/kp/images/foto/lide/michaela.jpg',
	...
	{
		name: 'Mgr. Markéta Paprotová', pos: 'Psycholožka ve zdravotnictví', img: '/kp/images/foto/lide/marketa.jpg',
