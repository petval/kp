...
// import logoSrc2 from "../../../public/images/kp.site.logo.png?height=64&png"
...
export default component$(() => (
  ...
  // <span class="self-center ml-1 text-l md:text text-gray-900 whitespace-nowrap dark:text-white flex items-center">
    <span class="self-center m-1 text-1xl md:text-xl font-bold text-gray-900 whitespace-nowrap dark:text-white flex items-center">
      {Constants.Names.Owner}
    </span>
));
